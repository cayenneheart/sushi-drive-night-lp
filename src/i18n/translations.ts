export const translations = {
  ...
  ja: {
    hero: {
      title: "SusHi Drive Night",
      subtitle: "一夜限りの、本物の文化体験とグローバルな出会い。",
      cta: "詳細を見る",
      scroll: "スクロール",
    },
    value: {
      culture: {
        label: "Culture",
        heading: "表面だけではない、本物の日本を体験する。",
        body: "茶道、三味線、何世代も受け継がれてきた職人の技。これは観光ではない — 本物への招待状です。",
      },
      network: {
        label: "Network",
        heading: "世界のエコシステムを創る人々と出会う。",
        body: "10カ国以上から集まる起業家、投資家、エコシステムリーダー。一つの場所で、一夜のうちに。",
      },
      nextgen: {
        label: "Next Gen",
        heading: "日本で最も野心的な学生と繋がる。",
        body: "次の時代を創る若き起業家たち。グローバルな志と、地に足のついた実行力を持つ学生たちです。",
      },
    },
    cta: {
      heading: "東京が呼んでいる。",
